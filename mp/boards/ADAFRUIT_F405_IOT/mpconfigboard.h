// ADAFRUIT_F405_IOT to store filesysem on SPI Flash instead of internal STM32 Flash

#define MICROPY_HW_BOARD_NAME       "Adafruit Feather STM32F405"
#define MICROPY_HW_MCU_NAME         "STM32F405RG"

// 1 = use STM32 internal flash (1 MByte)
// 0 = use onboard external SPI flash (2 MBytes)
...
// 16 Mbit (2 MByte) external SPI flash
...
// Network configuration (for wifi coprocessor compatiblity)
